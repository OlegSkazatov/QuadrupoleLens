...
class Beam:
    def __init__(self, parameters):
        ...
        self.a = beam_ellipse['a'] * 1e-3  # Большая полуось [м]
        self.b = beam_ellipse['b'] * 1e-3  # Малая полуось [м]
    ...
    def generate_particles(self, num_samples):
        ...
        if self.density_profile == 'gaussian':
            # Генерация по Гауссу с обрезкой на 3σ
        ...
        global_coords = self._calculate_rotation_matrix(self.direction) @ local_coords
    ...
    def _calculate_rotation_matrix(self, direction):
    ...
    def get_bounding_box(self):
        ...
        global_points = (self._calculate_rotation_matrix(self.direction) @ points.T).T + self.position
